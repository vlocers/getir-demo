...
function Header() {
  return (
    <div className="flex items-center w-full bg-primary h-11 ">
      <div className="container flex flex-row justify-between mx-auto sm:px-8 ">
        <div
        ...
        <div className="flex text-gray-300 gap-x-7 ">
          <button className="hidden md:flex  items-center text-sm gap-x-1.5 cursor-pointer hover:text-white ">
            <CiGlobe className="text-lg" /> <p>Türkçe (TR)</p>
          </button>
          <button className="hidden md:flex items-center text-sm gap-x-1.5 cursor-pointer hover:text-white">
            <FiUser />
            <p>Giriş Yap</p>
          </button>
          <button className="hidden md:flex items-center gap-x-1.5 text-sm cursor-pointer hover:text-white">
            <FiUserPlus />
            <p>Kayıt Ol</p>
          </button>
        </div>
